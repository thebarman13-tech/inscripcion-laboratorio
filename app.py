...
def registro():
    ...
    if request.method == "POST":
        ...
        if alumno:
            ...
            cur.execute(
                "INSERT INTO alumnos (nombre, apellido, telefono, nivel) VALUES (?, ?, ?, ?)",
        ...
        if cur.fetchone():
            err = "Ya estás registrado ese día"
        else:
            cur.execute(
                "INSERT INTO asistencias (alumno_id, fecha, turno) VALUES (?, ?, ?)",
